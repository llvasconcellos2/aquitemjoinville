...
require_once($mosConfig_absolute_path."/administrator/components/com_swmenufree/ImageManager/config.inc.php");

require_once($mosConfig_absolute_path."/administrator/components/com_swmenufree/ImageManager/Classes/ImageManager.php");
