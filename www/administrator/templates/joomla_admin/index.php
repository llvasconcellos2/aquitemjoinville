...
<div id="wrapper">
	<div id="header">
			<div id="joomla">
			  <div >
			    <div><img src="templates/joomla_admin/images/header_text.png" alt="Logo Joomla!" /></div>
			  </div>
			</div>
  </div>
</div>
...
<a href="http://www.joomlaclube.com.br/" target="_blank"><strong>JoomlaClube</strong></a><br />
<br /></div>
			...
			<div align="center" class="smallgrey">
				<?php echo $version; ?>
				<br />
				<a href="http://www.joomla.org/content/blogcategory/32/66/" target="_blank">Clique aqui - para checar vers�o mais recente </a>
			<br /> <br />
		  </div>			
			<?php
			if ( $mosConfig_debug ) {
				...
				printf ("P�gina foi gerada em %f segundos", $totaltime);
				echo '</div>';
			}
			?>--></td>
	</tr>
